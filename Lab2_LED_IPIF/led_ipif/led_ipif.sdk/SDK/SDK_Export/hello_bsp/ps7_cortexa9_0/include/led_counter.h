/*****************************************************************************
* Filename:          E:\0152021\led_ipif\led_ipif.srcs\sources_1\edk\system/drivers/led_counter_v1_00_a/src/led_counter.h
* Version:           1.00.a
 ...
 * @note
 * C-style signature:
 * 	void LED_COUNTER_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 LED_COUNTER_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	void LED_COUNTER_mWriteSlaveRegn(u32 BaseAddress, unsigned RegOffset, u32 Value)
 * 	u32 LED_COUNTER_mReadSlaveRegn(u32 BaseAddress, unsigned RegOffset)
 *
 */
#define LED_COUNTER_mWriteSlaveReg0(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (LED_COUNTER_SLV_REG0_OFFSET) + (RegOffset), (u32)(Value))
#define LED_COUNTER_mWriteSlaveReg1(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (LED_COUNTER_SLV_REG1_OFFSET) + (RegOffset), (u32)(Value))
#define LED_COUNTER_mWriteSlaveReg2(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (LED_COUNTER_SLV_REG2_OFFSET) + (RegOffset), (u32)(Value))
